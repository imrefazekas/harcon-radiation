...
module.exports = {
	...
	rester: function( rest, options ) {
		...
		self.toREST.forEach( function(firestarter){
			self.options.logger.radiationlog( null, 'Posteriorly executed publishing for REST...', { name: firestarter.name }, self.options.logLevel );
