...
var VERSION = exports.VERSION = '0.6.6';
...
radiation.dorest = function( firestarter ){
	...
	this.publish( firestarter, 'REST', function(firestarter, service){
		...
		self.restify.post( path, function( request, content, callback ){
			...
			self.ignite( clerobee.generate(), { request: request, content: content }, firestarter.division, firestarter.context + '.' + service, params, callback );
		}, null, security );
		return path;
	} );
};
