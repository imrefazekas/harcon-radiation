...
radiation.rester = function( rest, options ) {
	...
	this.toREST.forEach( function(firestarter){
		this.logger.radiationlog( null, 'Posteriorly executed publishing for REST...', firestarter, self.logLevel );
		self.dorest( firestarter );
	} );
...
radiation.io = function( io ) {
	...
	this.toWebsocket.forEach( function(firestarter){
		this.logger.radiationlog( null, 'Posteriorly executed publishing for Websocket...', firestarter, self.logLevel );
		self.dosocket( firestarter );
	} );
